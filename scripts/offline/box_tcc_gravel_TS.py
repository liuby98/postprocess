...
# -------------------------- 核心参数配置 --------------------------
csv_file = '/share/home/dq135/draw/scripts/gravel_TS_srf_TCC.csv'  # CSV数据文件路径
x_col = 'Gravel content'  # CSV中自变量X的列名
y_col = 'Soil Temperature TCC (Surface)'  # CSV中因变量Y的列名
group_col = 'Group'  # CSV中分组列的列名
x_label = 'Gravel content'  # 图中X轴的标签
y_label = 'Soil Temperature TCC (Surface)'  # 图中Y轴的标签
output_filename = 'curve_TS_TCC_gravel_srf.png'  # 输出图片的文件名
