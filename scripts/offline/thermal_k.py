...
for k in range(10):
    ...
    tc_win, tc_spr, tc_sum = t_ctl_win[k], t_ctl_spr[k], t_ctl_sum[k]
    te_win, te_spr, te_sum = t_exp_win[k], t_exp_spr[k], t_exp_sum[k]
    th_c_win, th_c_spr, th_c_sum = theta_ctl_win[k], theta_ctl_spr[k], theta_ctl_sum[k]
    th_e_win, th_e_spr, th_e_sum = theta_exp_win[k], theta_exp_spr[k], theta_exp_sum[k]
    ...
    k_c_win = calc_k(tc_win, Sr_c_win, tkd_c, tksu_c, tksf_c, vom_c, vs_c, vgr_c, alf_c, bet_c)
    ...
    k_e_win = calc_k(te_win, Sr_e_win, tkd_e, tksu_e, tksf_e, vom_e, vs_e, vgr_e, alf_e, bet_e)
