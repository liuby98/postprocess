...
base_input_path="/share/home/dq135/CRESM_0307S92/SCRIPTS/ICBCScripts/PrepCoLM/CN_15km/CoLMrun_nogravel/unstructured_cwrf_CN_15km_nogravel/history/unstructured_cwrf_CN_15km_nogravel_hist_"
base_output_path="/share/home/dq135/draw/process/dir/"
...
for year in {2001..2017}; do
    ...
    for ym in "${year}-03" "${year}-04" "${year}-05" "${year}-06" "${year}-07" "${year}-08"; do
        ...
        output_name="${base_output_path}colmoff_${ym}_nogravel.nc"
...
cdo mergetime $out_list colmoff_2001-2017_uv_nogravel.nc
